...
@section('content')
    ...
    <!-- Search and Filters -->
    <x-search-filters action="{{ route('entities.students.index') }}"
        search-placeholder="Search students by name, ID, email, rank, or company..." :date-range="false">
        <div>
    ...
    <script>
        ...
        function performBulkAction() {
            ...
            let confirmMessage =
                `Are you sure you want to perform this action on ${selectedStudents.length} selected student(s)?`;
