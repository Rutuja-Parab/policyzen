            ...
            <form method="POST" action="{{ route('entities.students.update', $student) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <select name="course_id"
                            ...
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}"
                                    {{ old('course_id', $selectedCourseId ?? null) == $course->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="number" name="age" value="{{ old('age', $student->age) }}" min="1"
                            max="100"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#2b8bd0] focus:border-transparent"
                            placeholder="25">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="rank" value="{{ old('rank', $student->rank) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#2b8bd0] focus:border-transparent"
                            placeholder="1">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_of_joining"
                            value="{{ old('date_of_joining', $student->date_of_joining ? $student->date_of_joining->format('Y-m-d') : '') }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#2b8bd0] focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_of_exiting"
                            value="{{ old('date_of_exiting', $student->date_of_exiting ? $student->date_of_exiting->format('Y-m-d') : '') }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#2b8bd0] focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="sum_insured" step="0.01" min="0"
                            value="{{ old('sum_insured', $student->sum_insured) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#2b8bd0] focus:border-transparent"
                            placeholder="50000">
                    </div>
