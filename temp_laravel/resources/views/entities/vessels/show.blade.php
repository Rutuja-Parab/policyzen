...
<a href="{{ route('entities.vessels.edit', $vessel) }}" class="bg-[#f06e11] text-white px-4 py-2 rounded-lg hover:bg-[#f28e1f]">
    ...
    <div>
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="p-6 space-y-4">
                <a href="{{ route('entities.vessels.edit', $vessel) }}" class="w-full bg-[#f06e11] text-white px-4 py-3 rounded-lg hover:bg-[#f28e1f] flex items-center justify-center">
                    <i class="fas fa-edit mr-2"></i>Edit Vessel
                </a>
