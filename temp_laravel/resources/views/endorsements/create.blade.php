...
<head>
    ...
    <title>Create Endorsement - PolicyZen</title>
        ...
        <div class="w-64 bg-white shadow-lg">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('endorsements.index') }}" class="flex items-center space-x-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-lg">
        ...
        <div class="flex-1">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('endorsements.index') }}" class="text-gray-400 hover:text-gray-600">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1 class="text-2xl font-bold text-gray-900">Create Endorsement</h1>
                    </div>
                    <div class="flex items-center space-x-4">
            ...
            <main class="p-6">
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="p-6">
                        <form method="POST" action="{{ route('endorsements.store') }}">
                            @csrf
